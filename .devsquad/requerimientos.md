...
| # | Pregunta | Efecto |
|---|---|---|
| **PA-1** | Subcategorías finales de los 6 grupos (reiniciado 2026-09-20, ver `docs/contexto-negocio.md` §3). **Automatización e Intrusión ya cerrada** (19 subcategorías). Faltan los otros 5 grupos. | Son datos, no estructura. Se cargan cuando lleguen. |
