...
import type { EstadoPedido, OrderRow } from "@/types/database";
        ...
        <>
          ...
          <div className="cuenta-movil-solo">
            ...
            {pedidosMovil.length === 0 ? (
              <p style={{ margin: 0, fontSize: 14.5, color: "#9FB2C3" }}>No hay pedidos con este filtro.</p>
            ) : (
...
function TarjetaPedidoMovil({ pedido: o }: { pedido: OrderRow }) {
